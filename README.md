...
###  Technical Expertise
- **AI & Machine Learning:** Developing predictive models (Random Forest, Decision Trees) and deploying solutions for IoT security. 
- **Data Analytics:** Expert in Python (Pandas, NumPy), Power BI (DAX), SQL, and Tableau for interactive reporting.
